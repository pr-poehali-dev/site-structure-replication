...
'Снова в школу — обе лиги',
'🎒 Снова в школу — стартуем учебный год турниром!',
'<!DOCTYPE html>
<html lang="ru">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Снова в школу — Лига субботы и Лига воскресенья</title>
</head>
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; max-width:600px; width:100%;">
        ...
        <tr>
          <td>
            <img src="https://cdn.poehali.dev/projects/da0c042d-2017-4baf-94fb-5da234e7b163/bucket/tournaments/98e88b4ad1d1.png" alt="Снова в школу" width="600" style="display:block; width:100%; height:auto;">
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px 32px 8px;">
            <h1 style="margin:0; color:#141414; font-size:26px; line-height:1.3;">♟️ Снова в школу</h1>
            <p style="margin:6px 0 0; color:#E8B600; font-size:16px; font-weight:bold;">Старт нового учебного года — выбирай удобный день</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:8px 32px 0;">
            <p style="margin:0; color:#444444; font-size:15px; line-height:1.6;">
              Всероссийский онлайн-турнир по шахматам для детей до 13 лет к началу нового учебного года! Деление по рейтингу ФШР, отдельный зачёт по возрастным подгруппам. Играй в удобный день — участвуй хоть в одном, хоть в обоих! 🎒
            </p>
          </td>
        </tr>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0 6px;">
                    <tr>
                      <td style="background-color:#faf7ec; border-radius:8px; padding:10px 14px; width:50%;" valign="top">
                        ...
                        <div style="color:#141414; font-size:14px; font-weight:bold;">5 сентября, 14:00 МСК</div>
                      </td>
                ...
                <td style="padding:18px 20px;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0 6px;">
                    <tr>
                      <td style="background-color:#faf7ec; border-radius:8px; padding:10px 14px; width:50%;" valign="top">
                        <div style="color:#999999; font-size:10px; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:2px;">Дата и время</div>
                        <div style="color:#141414; font-size:14px; font-weight:bold;">6 сентября, 12:00 МСК</div>
                      </td>
                      <td style="width:10px;"></td>
                      <td style="background-color:#faf7ec; border-radius:8px; padding:10px 14px; width:50%;" valign="top">
                        <div style="color:#999999; font-size:10px; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:2px;">Взнос</div>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0 8px;">
              <tr>
                <td style="background-color:#faf7ec; border-radius:10px; padding:14px 16px; width:50%;" valign="top">
                  ...
                  <div style="color:#141414; font-size:15px; font-weight:bold;">10+5</div>
                </td>
        ...
        <tr>
          <td style="padding:24px 32px 8px;" align="center">
            <a href="https://cdn.poehali.dev/projects/da0c042d-2017-4baf-94fb-5da234e7b163/bucket/tournaments/82bd924b1e6f.pdf" target="_blank" style="color:#8a6d00; text-decoration:underline; font-size:13px;">Положение о турнире — Лига субботы (PDF)</a>
          </td>
        </tr>
        <tr>
          <td style="padding:0 32px 24px;" align="center">
            <a href="https://cdn.poehali.dev/projects/da0c042d-2017-4baf-94fb-5da234e7b163/bucket/tournaments/ebcc28a40c2e.pdf" target="_blank" style="color:#8a6d00; text-decoration:underline; font-size:13px;">Положение о турнире — Лига воскресенья (PDF)</a>
          </td>
        </tr>
