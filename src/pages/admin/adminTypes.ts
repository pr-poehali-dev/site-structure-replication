export interface Tournament {
  ...
  location: string; age_category: string; price: number | null; time_control: string; created_at: string;
  status: string;
...
export const EMPTY_T_FORM = { title: '', description: '', date: '', location: '', age_category: '', price: '', time_control: '', diploma_sample_url: '', regulation_url: '', announcement_url: '' };
