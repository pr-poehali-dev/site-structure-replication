          ...
          {NAV.map((n) => (
            n.href === '/turnir' ? (
              <a
                key={n.href}
                href={n.href}
                className="relative px-4 py-2 rounded-lg text-sm font-bold text-white shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200 bg-emerald-500"
              >
                {n.label}
              </a>
            ) : (
          ...
          {NAV.map((n) => (
            n.href === '/turnir' ? (
              <a
                ...
                className="my-1 px-3 py-2 rounded-lg text-sm font-bold text-white shadow-md bg-emerald-500 w-fit"
              >
                {n.label}
              </a>
            ) : (
