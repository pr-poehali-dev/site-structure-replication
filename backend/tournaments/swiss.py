...
здесь как подстраховка: если последний раунд турнира фактически доигран, но
статус турнира так и не был переведён в 'finished' (никто не заходил в
турнирный зал после последнего хода), GET-запрос списка турниров в админке
сам находит такие турниры и дозавершает их.
"""
